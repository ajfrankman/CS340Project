...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            mainActivityPresenter.isFollower(selectedUser);
        }
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (followButton.getText().toString().equals(v.getContext().getString(R.string.following))) {
                    mainActivityPresenter.unfollow(Cache.getInstance().getCurrUserAuthToken(), selectedUser);
    ...
    public void onStatusPosted(String post) {
        ...
        postingToast.show();
        mainActivityPresenter.postStatus(post);
    }

    @Override
    public void updateSelectedUserFollowingAndFollowers() {
        // Get count of most recently selected user's followers.
        mainActivityPresenter.getFollowersCount(Cache.getInstance().getCurrUserAuthToken(), selectedUser);
        // Get count of most recently selected user's followees (who they are following)
        mainActivityPresenter.getFollowingCount(Cache.getInstance().getCurrUserAuthToken(), selectedUser);
    }
    ...
    @Override
    public void isFollowingButton(boolean isFollower) {
